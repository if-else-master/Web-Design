...
<body>
	...
	<section class="ad">
		<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Labore dicta cum aperiam eius. Tempora quisquam
			odit ad
			in aliquam enim?</p>
	</section>
	...
	<section class="container">
		...
		?>
				...
				<div class="thumbnail row-fluid del">
					<div class="span4">#<?= $row['id'] ?></div>
					<div class="span8">本篇已被刪除</div>
				</div>
			...
			?>
				...
				<div class="thumbnail row-fluid">
					...
					<div class="span8">
						<p>玩家留言:<span class="info"><?= $row['info'] ?></span></p>
						<div class="bottom">
