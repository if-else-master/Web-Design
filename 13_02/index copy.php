...
<body>
    ...
    <section class="ad">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur vel quam cum, nobis iste officia molestias
            architecto nulla quidem sint. Expedita, obcaecati tempore odio fugiat adipisci nam! Illo, est veritatis.</p>
    </section>
    ...
    <section class="container">
        ...
        <div class="thumbnail row-fluid">
            <div class="span4">
                <img src="img/bg.jpg" class="img-circle" width="100" height="100">
                <h4>玩家名稱：<?= $row['user'] ?></h4>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    for ($i = 1; $i <= $num; $i++) {
                        ...
                        echo '<tr>
                            <td><div class="jpg" style="background: url(img/'.$row['info'].');">'.$row['user'].'</div></td>
                            <td>VS</td>';
                        $row = array_shift($rows); 
                        ...
                        <td><div class="jpg" style="background: url(img/wait.jpg);">等待匹配中</div></td></tr>
                        ';
                    }
                    ?>
                </tbody>
